...
define('TABLE_CATEGORIES_PATH', DB_PREFIX . 'category_path');
define('TABLE_CATEGORIES_STORE', DB_PREFIX . 'category_to_store');
define('TABLE_CATEGORIES_DESCRIPTION', DB_PREFIX . 'category_description');
define('TABLE_CONFIGURATION', DB_PREFIX . 'setting');
...
define('TABLE_LANGUAGES', DB_PREFIX . 'language');
define('TABLE_LAYOUT_BOXES', DB_PREFIX . 'layout_boxes');
define('TABLE_MANUFACTURERS', DB_PREFIX . 'manufacturer');
define('TABLE_MANUFACTURERS_INFO', DB_PREFIX . 'manufacturer_to_store');
...
define('TABLE_ORDERS', DB_PREFIX . 'order');
define('TABLE_ORDERS_PRODUCTS', DB_PREFIX . 'order_product');
define('TABLE_ORDERS_PRODUCTS_ATTRIBUTES', DB_PREFIX . 'orders_product_attributes');
define('TABLE_ORDERS_PRODUCTS_DOWNLOAD', DB_PREFIX . 'orders_product_download');
define('TABLE_ORDERS_STATUS', DB_PREFIX . 'order_status');
define('TABLE_ORDERS_STATUS_HISTORY', DB_PREFIX . 'order_history');
define('TABLE_ORDERS_TYPE', DB_PREFIX . 'order_type');
define('TABLE_ORDERS_TOTAL', DB_PREFIX . 'order_total');
...
define('TABLE_PRODUCTS_STORE', DB_PREFIX . 'product_to_store');
define('TABLE_PRODUCTS_ATTRIBUTES_DOWNLOAD', DB_PREFIX . 'products_attributes_download');
define('TABLE_PRODUCTS_DESCRIPTION', DB_PREFIX . 'product_description');
...
define('TABLE_PRODUCTS_TO_CATEGORIES', DB_PREFIX . 'product_to_category');
...
define('TABLE_SPECIALS', DB_PREFIX . 'review');
define('TABLE_TEMPLATE_SELECT', DB_PREFIX . 'template_select');
define('TABLE_TAX_CLASS', DB_PREFIX . 'tax_class');
define('TABLE_TAX_RATES', DB_PREFIX . 'tax_rate');
define('TABLE_GEO_ZONES', DB_PREFIX . 'geo_zone');
define('TABLE_ZONES_TO_GEO_ZONES', DB_PREFIX . 'zone_to_geo_zone');
...
define('TABLE_ZONES', DB_PREFIX . 'zone');